...
Ttr       					 = waver[:npts]
t0                           = 5.
Rf                           = decv.deconvolve(Ztr=Ttz, Rtr=Ttr, dt=dt, npts=npts, tdel=t0, f0=2.5)
maxData                      = 1024
rfr                          = Rf[:maxData]
...
#  maxdata = 1024
start 					     = timeit.default_timer()
rx0, rxhv, rzhv              = theo.theo(nl, vsin, tthick, vpvs, qpin, qsin, fs, din, gaus, minAmp, t0, nn)
stop 					     = timeit.default_timer()
